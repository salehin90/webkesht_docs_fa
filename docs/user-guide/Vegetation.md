            ...
            <div class="main-section">
                ...
                <div class="section-content ">
                    <div class="section-body">
                        ...
                        <div class="highlight">
                            <strong>⚠️ توجه:</strong> این نکته ضروری است که مقدار این پارامتر برای کل عرصه بیان می‌گردد نه برای یک گیاه خاص. بنابراین پارامتر فاکتور تراکم، نیاز آبی و مدیریت آبیاری برای کل عرصه مطرح می‌گردد.
                        </div>
                    </div>
                </div>
            </div>
